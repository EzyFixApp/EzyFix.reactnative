...
export default function ForgotPasswordScreen({
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      if (__DEV__) {
        console.log('✅ OTP validated successfully', { email: contact.trim().toLowerCase() });
      }
      ...
      setError(error.reason || 'Mã OTP không chính xác');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      if (__DEV__) {
        console.log('📧 OTP resent successfully', { email: contact.trim().toLowerCase() });
      }
      ...
      setError(error.reason || 'Không thể gửi lại OTP');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      if (__DEV__) {
        console.log('✅ Password reset successful', { email: contact.trim().toLowerCase() });
      }
      ...
      setError(error.reason || 'Đổi mật khẩu thất bại');
    } finally {
      setIsLoading(false);
    }
  };
